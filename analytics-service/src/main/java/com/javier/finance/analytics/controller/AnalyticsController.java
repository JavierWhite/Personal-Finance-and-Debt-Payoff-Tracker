...
public class AnalyticsController {
    ...
    public MonthlyFinanceSnapshot findById(@PathVariable Long id) { return service.findById(id); }
    ...
    public FinanceSummaryResponse summary(@PathVariable Long userId) { return service.summary(userId); }

    @GetMapping("/user/{userId}/debt-chart")
    public List<ChartDataPoint> debtChart(@PathVariable Long userId) { return service.debtChart(userId); }

    @GetMapping("/user/{userId}/savings-chart")
    public List<ChartDataPoint> savingsChart(@PathVariable Long userId) { return service.savingsChart(userId); }

    @GetMapping("/user/{userId}/net-worth-chart")
    public List<ChartDataPoint> netWorthChart(@PathVariable Long userId) { return service.netWorthChart(userId); }
}
